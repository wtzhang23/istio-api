...
type ServerTLSSettings struct {
	...
	// Optional: If specified, overrides the default ALPN list.
	// This is typically used to only allow clients to negotiate
	// a specific protocol (e.g. http/1.1 instead of both http/1.1 and h2).
	// This field is only applicable when TLSMode is set to SIMPLE, MUTUAL,
	// or OPTIONAL_MUTUAL.
	Alpns         []string `protobuf:"bytes,14,rep,name=alpns,proto3" json:"alpns,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServerTLSSettings) GetAlpns() []string {
	if x != nil {
		return x.Alpns
	}
	return nil
...
var file_networking_v1alpha3_gateway_proto_rawDesc = string([]byte{
	...
	0x22, 0xae, 0x07, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x54, 0x4c, 0x53, 0x53, 0x65,
	...
	0x68, 0x65, 0x72, 0x53, 0x75, 0x69, 0x74, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x6c, 0x70,
	0x6e, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x61, 0x6c, 0x70, 0x6e, 0x73, 0x22,
	0x6f, 0x0a, 0x07, 0x54, 0x4c, 0x53, 0x6d, 0x6f, 0x64, 0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x50, 0x41,
	...
	,
